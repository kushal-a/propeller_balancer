...
static const int Propeller_balancer__frequency = 50;
...
static const int Propeller_balancer__pwmMax = 100;

static const int Propeller_balancer__vMax = 100;

static const int Propeller_balancer__sensor_min = 214;

static const int Propeller_balancer__sensor_max = 955;
...
static const int Propeller_balancer__motor_min[2] = {24, 22};

static const int Propeller_balancer__motor_max[2] = {255, 250};
