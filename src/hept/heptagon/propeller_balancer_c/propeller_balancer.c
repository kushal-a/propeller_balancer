...
void Propeller_balancer__abs_step(float a, Propeller_balancer__abs_out* _out) {
  ...
  float c_true;
  int ck;
  Mc_ext__int_of_float_step(a, &Mc_ext__int_of_float_out_st);
  v = Mc_ext__int_of_float_out_st.o;
  ck = (v>0);
  if (ck) {
    c_true = a;
    _out->c = c_true;
...
void Propeller_balancer__traj_step(Propeller_balancer__traj_out* _out,
  ...
  float v_3;
  float v_2;
  Mc_ext__float_of_int_step(Propeller_balancer__frequency,
                            &Mc_ext__float_of_int_out_st);
  v_8 = Mc_ext__float_of_int_out_st.o;
  Mc_ext__float_of_int_step(Propeller_balancer__frequency,
                            &Mc_ext__float_of_int_out_st);
  v_3 = Mc_ext__float_of_int_out_st.o;
  _out->theta = 0.000000;
...
void Propeller_balancer__remapped_sensor_values_step(int raw, int sensor_num,
  ...
  int v_10;
  int v;
  int value_false_false;
  int value_false_true;
  int ck_1;
  int value_false;
  int value_true;
  int ck;
  ...
  if (ck) {
    ...
    if (ck_1) {
      ...
      Mc_ext__float_of_int_step(741, &Mc_ext__float_of_int_out_st);
      v_12 = Mc_ext__float_of_int_out_st.o;
      v = (raw-Propeller_balancer__sensor_min);
      v_10 = (1000*v);
      Mc_ext__float_of_int_step(v_10, &Mc_ext__float_of_int_out_st);
      v_11 = Mc_ext__float_of_int_out_st.o;
      v_13 = (v_11/v_12);
      Mc_ext__int_of_float_step(v_13, &Mc_ext__int_of_float_out_st);
      value_false_false = Mc_ext__int_of_float_out_st.o;
...
void Propeller_balancer__pd_step(float theta,
  ...
  setpoint = Propeller_balancer__traj_out_st.theta;
...
void Propeller_balancer__thrust_diff_saturation_step(float theta,
  ...
  Mc_ext__int_of_float_step(v_31, &Mc_ext__int_of_float_out_st);
  v_32 = Mc_ext__int_of_float_out_st.o;
  ck = (v_32<0);
  if (ck) {
...
void Propeller_balancer__optimal_thrust_step(float thrust_diff,
  ...
  Propeller_balancer__interpolate_out Propeller_balancer__interpolate_out_st;
  Mc_ext__int_of_float_out Mc_ext__int_of_float_out_st;
  ...
  v_34 = (um-thrust_diff);
  v_35 = (0.500000*v_34);
  Mc_ext__int_of_float_step(thrust_diff, &Mc_ext__int_of_float_out_st);
  v = Mc_ext__int_of_float_out_st.o;
  ck = (v>0);
  p_max[0] = v_35;
  p_max[1] = v_37;
  ...
  };
  {
    int i;
    for (i = 0; i < 2; ++i) {
      Propeller_balancer__interpolate_step(p_min[i], p_max[i],
                                           &Propeller_balancer__interpolate_out_st);
      _out->u[i] = Propeller_balancer__interpolate_out_st.out;
    }
  };;
}
...
void Propeller_balancer__remapped_motor_values_step(float raw_thrust,
  ...
  Mc_ext__int_of_float_step(raw_vel, &Mc_ext__int_of_float_out_st);
  v = Mc_ext__int_of_float_out_st.o;
